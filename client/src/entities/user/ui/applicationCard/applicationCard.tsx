...
export const ApplicationCard: FC<ApplicationCardProps> = ({
  ...
  return (
    <div className="mb-4 overflow-hidden bg-white border shadow-sm rounded-xl">
      <div className="flex flex-col items-start justify-between gap-6 px-6 py-6 lg:flex-row lg:items-center md:px-4 lg:gap-4">
        {/* Property Info Section */}
        <div className="flex flex-col w-full gap-5 lg:flex-row lg:w-auto">
          <Image
            src={imgSrc}
        ...
        {/* Status Section */}
        <div className="flex flex-col justify-between w-full gap-3 py-2 lg:basis-2/12 lg:h-48 lg:gap-0">
          <div>
        ...
        <div className="flex flex-col justify-start w-full gap-5 py-2 lg:basis-3/12 lg:h-48">
          <div>
