...
import { cleanParams, cn, formatEnumString } from "@shared/lib";
import {
  FiltersState,
  initialState,
  setFilters,
...
import { Button, CustomSelect, Input, Label, Slider } from "@shared/ui";
...
export const FiltersFull: FC = () => {
  ...
  return (
    <div className="h-full px-4 pb-10 overflow-auto bg-white rounded-lg">
      <div className="flex flex-col space-y-6">
        ...
        <div>
          ...
          <div className="flex items-center">
            <Input
              ...
              className="border-r-0 rounded-r-none rounded-l-xl"
            />
            <Button
              onClick={handleLocationSearch}
              className="border border-black rounded-l-none shadow-none rounded-r-xl border-l-none hover:bg-primary-700 hover:text-primary-50"
            >
        ...
        <div className="flex gap-4 mt-6">
          <Button
            ...
            className="flex-1 text-white bg-primary-700 rounded-xl"
          >
            APPLY
          </Button>
          <Button
